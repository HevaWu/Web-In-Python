...
def loadLexicon(fname):
    newLex=set()  #list allow duplicates, set do not , set also easily to search element
    lex_conn=open(fname)
	...
	for line in fin: # for every line in the file (1 review per line)
		...
		reviews.append(line)
    		...
    		for word in words: #for every word in the review
        		if word in posLex: # if the word is in the positive lexicon  ---- use set to complete this, just use in,
...
if __name__ == "__main__":   
    #python week3.py  use this part to do something
    #import function in the file
    #use this as tool box, use this after function, tell python import this
    #like main function

	reviews,decisions=run('textfile')

	for i in range(len(reviews)): #range(0,6)  --- 0,1,2,3,4,5    i start from 0
